...
replace(replace(replace(JSON_EXTRACT(mi.form_data,'$.applicationImpacte_value'),'[',''),']',''),'"','') AS applicationimpacted,
replace(replace(replace(JSON_EXTRACT(mi.form_data,'$.applicationImpacte'),'[',''),']',''),'"','') AS applicationimpacted_id,
...
replace(replace(replace(JSON_VALUE(mi.form_data,'$.CountryImpacte_value'),'[',''),']',''),'"','') AS countryimpacted,
replace(replace(replace(JSON_VALUE(mi.form_data,'$.CountryImpacte'),'[',''),']',''),'"','') AS countryimpacted_id,
...
replace(replace(replace(JSON_VALUE(mi.form_data,'$.Deployment_Approach_value'),'[',''),']',''),'"','') AS deploymentapproach,
replace(replace(replace(JSON_VALUE(mi.form_data,'$.Deployment_Approach'),'[',''),']',''),'"','') AS deploymentapproach_id,
...
replace(replace(replace(JSON_VALUE(mi.form_data,'$.MajorChanges_value'),'[',''),']',''),'"','') AS cmcmajorchange,
replace(replace(replace(JSON_VALUE(mi.form_data,'$.MajorChanges'),'[',''),']',''),'"','') AS cmcmajorchange_id,
...
replace(replace(replace(JSON_VALUE(mi.form_data,'$.otherApplicationImpacted_value'),'[',''),']',''),'"','') AS otherapplicationimpacted,
replace(replace(replace(JSON_VALUE(mi.form_data,'$.otherApplicationImpacted'),'[',''),']',''),'"','') AS otherapplicationimpacted_id,
...
replace(replace(replace(JSON_VALUE(mi.form_data,'$.Resource_Engagement_value'),'[',''),']',''),'"','') AS resourceengagement,
replace(replace(replace(JSON_VALUE(mi.form_data,'$.Resource_Engagement'),'[',''),']',''),'"','') AS resourceengagement_id,
replace(replace(replace(JSON_VALUE(mi.form_data,'$.reversionapproach_value'),'[',''),']',''),'"','') AS reversionapproach,
replace(replace(replace(JSON_VALUE(mi.form_data,'$.reversionapproach'),'[',''),']',''),'"','') AS reversionapproach_id,
...
WHERE mi.biz_key LIKE 'CR20250226%';
